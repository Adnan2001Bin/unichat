...
export async function sendVerificationEmail({
  ...
  try {
    ...
    await transporter.sendMail({
      from: `"Student Connect" <${process.env.SENDER_EMAIL}>`,
      to: email,
      subject: "Verify Your Student Connect Account",
      html: `
        <!DOCTYPE html>
        <html>
        <head>
        ...
        <body>
          <div class="container">
            <div class="header">
              <h2>Welcome to Student Connect, ${userName}!</h2>
            </div>
            <div class="content">
              ...
              <p>If you didn’t sign up for Student Connect, please ignore this email.</p>
            </div>
            <div class="footer">
