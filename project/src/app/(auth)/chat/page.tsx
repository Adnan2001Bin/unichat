      ...
      socketInstance.on("message", (message: Message) => {
        if (
          ...
          ((message.senderId === selectedFriend._id &&
            message.recipientId === session.user._id) ||
      ...
      >
        <Card className="h-full bg-transparent flex flex-col border-none">
          <CardContent className="p-5 border-b border-gray-100 shadow-sm">
            <h2
              className="text-2xl font-extrabold flex items-center justify-between mb-4"
            ...
            searchQuery ? (
              ...
              <ul>
                  ...
                  >
                    {friend.profilePicture ? (
                      ...
                      <div
                        ...
                        style={{
                          background: THEME_PRIMARY_DARK_BLUE,
                          color: "white",
                        }}
                      >
                ...
                {searchResults.length > 0 && searchQuery && (
                  <li
                    className="p-4 pt-6 pb-2 text-sm font-semibold"
                    style={{ color: THEME_TEXT_DARK }}
                  >
                    New Users:
                  </li>
          ...
          {selectedFriend ? (
            <>
              ...
              <div
                ...
                style={{
                  background: `linear-gradient(to right, ${THEME_PRIMARY_DARK_BLUE}, ${THEME_ACCENT_GREEN})`,
                  color: "white",
                }}
              >
                <Button
              ...
              >
                {messages.length === 0 ? (
                  <div className="flex flex-col items-center justify-center h-full text-gray-500">
                    ...
                    <p
                      className="text-md text-center max-w-sm"
                      style={{ color: THEME_TEXT_LIGHT }}
                    >
                      Send your first message to {selectedFriend.userName} and
                      begin chatting.
                    </p>
                  </div>
                ) : (
                    ...
                    .filter(
                      (msg) =>
                        (msg.senderId === session?.user._id &&
                          msg.recipientId === selectedFriend._id) ||
                        (msg.senderId === selectedFriend._id &&
                          msg.recipientId === session?.user._id)
                    )
                    .map((msg, index) => (
                      <div
                        key={index}
                      ...
                      >
                        <div
                          ...
                          style={{
                            ...
                            border:
                              msg.senderId === session?.user._id
                                ? `1px solid ${THEME_BACKGROUND_LIGHT}`
                                : "none",
                          }}
                        >
              ...
              {/* Message Input Area */}
              <div
                className="p-5 border-t border-gray-100 shadow-lg"
            ...
            <div className="flex flex-col items-center justify-center h-full p-8 text-center">
              ...
              >
                ...
                projects. Select a friend from the sidebar to start a private
                conversation or click the{" "}
                <UserPlus
                  className="inline w-5 h-5 mb-1"
                  style={{ color: THEME_SECONDARY_BLUE }}
                />{" "}
                icon to add new connections.
              </p>
            </div>
          )}
        </Card>
