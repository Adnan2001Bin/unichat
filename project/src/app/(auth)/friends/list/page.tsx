...
// Define the FriendsData interface
                    ...
                    >
                        ...
                        {user.profilePicture ? (
                          <div className="relative w-14 h-14">
                            <Image
                              ...
                              style={{ border: `2px solid ${THEME_SECONDARY_BLUE}` }}
                            />
                          </div>
                        ) : (
                          <UserCircle
                      ...
                      <div className="flex space-x-2">
                        <button
                          ...
                          className="font-semibold transition-colors duration-200 text-blue-500 hover:text-blue-600"
                          style={{
                        ...
                        <Button
                          ...
                          className="text-white font-semibold py-2 px-3 rounded-lg flex items-center space-x-1 transition-all duration-200 bg-gray-500 hover:bg-gray-600"
                          title="Remove Friend"
                        >
